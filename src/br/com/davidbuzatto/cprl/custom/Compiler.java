...
public class Compiler {
    ...
    /**
     * Compile the source file. If there are no errors in the source file, the
     * object code is placed in a file with the same base file name as the
     * source file but with a ".asm" suffix.
     *
     ...
     * complete file name or the base file name with suffix ".cprl" omitted.
     */
